...
const EditProfile = ({ profile }: any) => {
  ...
  const [backgroundCSS, setbackgroundCSS] = useState<any>({
  ...
  const updateProfile = async () => {
    const _profile = {
      ...
      background: {
        type: backgroundType,
        data:
          backgroundType == "color" ? backgroundColor : selectedBackgroundImage,
      },
    };
    ...
    const r = await fetch("/api/updatepage", {
      body: params,
      method: "POST",
    }).then((res) => res);
  };
  ...
  return (
    <>
      <div className={styles.hidden}>{render}</div>
      <div className={styles.wrapper}>
        <div className={styles.sidebar}>x</div>
        <div className={styles.editContainer}>
          <div className={styles.menu}>
            <div
              className={styles.menuItem}
              onClick={() => {
                setSelectedScreen("links");
              }}
            >
              Links
            </div>
